...
export function useModalIsOpen(modal: ApplicationModal): boolean {
  const openModal = useAppSelector((state: AppState) => state.applicationv3.openModal)
...
export function useActivePopups(): AppState['applicationv3']['popupList'] {
  const list = useAppSelector((state: AppState) => state.applicationv3.popupList)
